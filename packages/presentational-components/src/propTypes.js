// redux-form compatible proptypes have been copied from https://github.com/erikras/redux-form/blob/master/src/propTypes.js
import PropTypes from 'prop-types';

const {
  any, bool, func, shape, string, oneOfType, object, number,
} = PropTypes;
